...
#%%
features,labels = l.features_labels(df,sig,cell='A375',all_cells=False, dmso=True)
le = LabelEncoder()
...
#%%
score = l.crossval_old(features,labels,'sgdc',splits = 5)
...
fig.show()
#%%
l.df_to_libsvm(features,labels_b,file_name='/media/sf_project/Linux/data_experiments/skbr3_libsvm', test=False)
#%%
